...
public class ScoreBarView extends View {
    ...
    private void getAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray typeArray = context.getTheme().obtainStyledAttributes(attrs,
                R.styleable.ScoreBarView, defStyleAttr, 0);
        try {
            mTextSize = typeArray.getDimensionPixelSize(R.styleable.ScoreBarView_barTextSize, dp2px(16));
            mBarHeight = typeArray.getDimensionPixelSize(R.styleable.ScoreBarView_barHeight, dp2px(32));
            mViewHeight = typeArray.getDimensionPixelSize(R.styleable.ScoreBarView_viewHeight,mBarHeight);
        } finally {
            typeArray.recycle();
        }
    }
    ...
    public ValueAnimator createValueChangeAnimation(int value, int duration) {
        if (scoreStyle == 1) value = (6 - value) * 20;
        finalValue = value;
